<?
	...
	if(isset($_POST["drplogdays"]) && $_POST["drplogdays"]!="")		{$iDays			=	mysql_real_escape_string($_POST["drplogdays"]);	$sCriteriaSQL	.=	" AND DATEDIFF(CURDATE(), tbl_log.login_datetime) >= ".$iDays;}
	if(isset($_POST["drpuser"]) && $_POST["drpuser"]!="")			{$iUSER_ID		=	mysql_real_escape_string($_POST["drpuser"]);		$sCriteriaSQL	.=	" AND tbl_log.user_id = ".$iUSER_ID;}
