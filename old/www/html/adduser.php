						...
						<form name="frm1" action="adduser.php" method="post">
							...
							<table cellpadding="0" cellspacing="5" border="0" width="650" align="center" class="box">
								...
								<tr>
									...
									<td><input type="text" name="txtlicensecountry" id="txtlicensecountry" value="" maxlength="60" style="width:250px;" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" name="txtmaxpassengers" id="txtmaxpassengers" value="" maxlength="2" style="width:250px;" /></td>
								</tr>
								<tr>
