			...
			if(mysql_num_rows($rsDEPT)>0){
				...
				if($bACTIVE_DEPT==0){
					$sMessage		=	fn_Print_MSG_BOX("<li class='bold-font'>Department is Inactive, vehicle cann't be charged", "C_ERROR");
							...
							$sSQL			=	"SELECT charge_id FROM tbl_restricted_charges WHERE vehicle_id = ".$_POST["drpvehicle"]." ".
							"AND charge_month = '".$_POST["drpmonth"]."' AND charge_year = '".$_POST["drpyear"]."'";
							...
							if($sMessage==""){
								...
								if($_POST["optmethod"]=="Total Charge"){
									...
									"VALUES(".$_POST["drpvehicle"].", '".$_POST["drpdept"]."', '".$_POST["drpmonth"]."', '".$_POST["drpyear"]."', 'Total Charge', ".$_POST["txttotalcharge"].")";
									...
									"VALUES(".$_POST["drpvehicle"].", '".$_POST["drpdept"]."', '".$_POST["drpmonth"]."', '".$_POST["drpyear"]."', 'Readings', ".$_POST["txtreadingcharges"].", ".
									"'".$_POST["txtstartreading"]."', '".$_POST["txtendreading"]."', ".$_POST["txtrate"].")";
								}
