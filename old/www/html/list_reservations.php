<?
	...
	if($sAction=="search"){
		...
		if(isset($_POST["resid"]) && $_POST["resid"]!="")					{$iRESERVATION_ID		=	mysql_real_escape_string($_POST["resid"]);																								}
		if(isset($_POST["txtresvno"]) && $_POST["txtresvno"]!="")			{$iRES_SEARCH_ID		=	mysql_real_escape_string($_POST["txtresvno"]);	   $sCriteriaSQL		.=	" AND r.res_id 			= ".$iRES_SEARCH_ID;	}
		...
		if(isset($_POST["drppending"]) && $_POST["drppending"]!="")	{
			$sStatus		=	mysql_real_escape_string($_POST["drppending"]);
