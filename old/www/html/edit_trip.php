<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="edittrip"){		
			...
			$sSQL="UPDATE tbl_trip_details SET begin_mileage = ".mysql_real_escape_string($_POST["txtbeginmileage"]).", ".
			"end_mileage = ".mysql_real_escape_string($_POST["txtendmileage"]).", end_gas_percent = '".mysql_real_escape_string($_POST["drpgas"])."', problem = ".$bPROBLEM." ".
			"WHERE trip_id = ".$iTRIP_ID;
			
			$rsTRIP=mysql_query($sSQL) or die(mysql_error());
			
			$sSQL	=	"UPDATE tbl_user_comments SET comments = '".mysql_real_escape_string(addslashes($_POST["txtproblem"]))."' WHERE trip_id = (SELECT res_id FROM tbl_trip_details WHERE trip_id =".$iTRIP_ID.")";
							...
							<table cellpadding="0" cellspacing="5" border="0" width="600" align="center" class="box">
								...
								<tr>
									...
									<?
										...
										"ORDER BY tbl_trip_details.res_id DESC";
										//print($sSQL);
