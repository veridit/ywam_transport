<?
	...
	if(isset($_REQUEST["action"])	&& $_REQUEST["action"]=="search"){
			...
			if(isset($_POST["tripid"]) && $_POST["tripid"]!="")	{$iTRIP_ID		=		mysql_real_escape_string($_POST["tripid"]);}
			...
			if(isset($_POST["drpdays"]) && $_POST["drpdays"]!="")		{$sDays			=	mysql_real_escape_string($_POST["drpdays"]);		$sCriteriaSQL	.=	" AND (DATEDIFF(CURDATE(), tbl_reservations.planned_return_day_time) <= ".$sDays." AND DATEDIFF(CURDATE(), tbl_reservations.planned_return_day_time) >0) ";}
