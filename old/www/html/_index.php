                                    ...
                                    <div class="menu-container-1"> 
                                      ...
                                      <div class="column-1"> 
                                        ...
                                        <ul>
                                          ...
                                          <li><a href="./html/adduser.php">User 
                                          ...
                                          <li><a href="./html/info_page.php?id=22">Driver: 
                                            Year End Notice Deactivation</a></li>
                                          <?	}?>
                                      ...
                                      <div class="column-1"> 
                                        ...
                                        <ul>
                                          ...
                                          <li><a href="./html/add_keycard_trip.php">Make 
                                            Trip Slip</a></li>
                                          <li><a href="./html/list_reservations.php">List 
                                            Trips</a></li>
                                          <li><a href="./html/add_tripdetails.php">Close 
                                            Trips Slip</a></li>
                                          <li><a href="./html/list_pending_trips.php">Close-Change-Delete 
                                            Pending Trips</a></li>
                                      ...
                                      <div class="column-1"> 
                                        ...
                                        <ul>
                                          ...
                                          <li><a href="./html/add_notice.php">Edit 
                                            Login Message</a></li>
                                          <li><a href="./html/info_page.php?id=10">Send 
							      ...
							      <li><a href="#">RESV</a> 
                                    <div class="menu-container-1"> 
                                      <div class="column-1"> 
										...
										if($bPERMISSION==1){
									?>
                                          <li><a href="./html/list_users.php">Drivers List</a></li>
                                          <li><a href="./html/list_school_cost.php">Trips 
                                            Taken</a></li>
                                          <?	}	?>
                                        </ul>
