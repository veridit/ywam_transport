	...
	?>
						...
						<form name="frm1" action="" method="post">
							...
							<table cellpadding="0" cellspacing="5" border="0" width="600" align="center" class="box">
								...
								<tr><td colspan="2" align="center"><input type="button" name="btnBACK" value="RETURN TO LIST" onClick="location.href='list_deleted_trips.php'" class="Button" style="width:170x;" /></td></tr>
