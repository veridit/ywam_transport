<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="search"){
			...
			if(isset($_POST["drpaction"]) && $_POST["drpaction"]!="")			{$iACTION_DUE	=	mysql_real_escape_string($_POST["drpaction"]);		$sCriteriaSQL	.=	" AND ((TIMESTAMPDIFF(WEEK, CURDATE(), v.safety_date) BETWEEN 1 AND ".$iACTION_DUE.")		OR		(TIMESTAMPDIFF(WEEK, CURDATE(), v.registration_date) BETWEEN 1 AND ".$iACTION_DUE."))";}
