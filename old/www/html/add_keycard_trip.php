<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="addkeycard"){
		...
		$sSQL="UPDATE tbl_reservations SET key_no = '".mysql_real_escape_string($_POST["txtkey"])."', card_no = '".mysql_real_escape_string($_POST["txtcard"])."', no_cost = ".$bNO_COST." WHERE res_id = ".$iRESERVATION_ID;
