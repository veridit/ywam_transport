<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="delete"){	
		...
		$sSQL		=	"UPDATE tbl_user SET active = 0 WHERE dept_id = '".$_POST["deptid"]."'";
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="search"){
		...
		if(isset($_POST["txtdeptno"]) && $_POST["txtdeptno"]!="")			{$sDEPT_ID	=	$_POST["txtdeptno"];		$sCriteriaSQL	.=	" AND d.dept_id = '".$sDEPT_ID."'";}
