<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="editdept"){		
		//==============================================
		$sSQL="UPDATE tbl_departments SET dept_name = '".trim(mysql_real_escape_string($_POST["txtdeptname"]))."', ".
		"leader_f_name = '".trim(mysql_real_escape_string($_POST["txtfname"]))."', leader_l_name = '".trim(mysql_real_escape_string($_POST["txtlname"]))."', ".
		"leader_phone = '".trim(mysql_real_escape_string($_POST["txtphone"]))."', leader_email = '".trim(mysql_real_escape_string($_POST["txtemail"]))."', dept_info = '".mysql_real_escape_string(addslashes($_POST["txtInfo"]))."' ".
