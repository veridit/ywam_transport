<?
	...
	if (isset($_POST["action"]) && $_POST["action"]=="change_password"){
		...
		$query="SELECT f_name FROM tbl_user WHERE user_id=".$_SESSION["User_ID"]." AND user_group = ".$_SESSION["User_Group"]." AND password='$OldPassword'";
		//print($query);
		...
		if ($iRecord==0)
			...
			$sSQL="UPDATE tbl_user set password='$NewPassword' WHERE user_id=".$_SESSION["User_ID"]." and password='$OldPassword'";
						...
						<form name="frm1" action="change_password.php" method="post">
							...
							<table cellpadding="0" cellspacing="5" border="0" width="500" align="center" class="box">
								...
								<tr>
									...
									<td width="300"><input type="password" name="txtoldpassword" value="" maxlength="10" style="width:150px;"  /></td>
								</tr>
								<tr>
									<td class="label">New Password:</td>
									<td><input type="password" name="txtpassword" value="" maxlength="10" style="width:150px;"  /></td>
								</tr>
								<tr>
									<td class="label">Confirm New Password:</td>
									<td><input type="password" name="txtconfirmpassword" value="" maxlength="10" style="width:150px;"  /></td>
								</tr>
