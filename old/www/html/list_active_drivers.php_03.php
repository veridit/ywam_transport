<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="search"){
		...
		if(isset($_POST["drpusers"]) && $_POST["drpusers"]!="")				{$iSEL_DRIVER	=	$_POST["drpusers"];			$sCriteriaSQL	.=	" AND u.l_name = '".$iSEL_DRIVER."'";}
		if(isset($_POST["drpusertype"]) && $_POST["drpusertype"]!="")		{
			$sUserType	=	$_POST["drpusertype"];
		...
		if(isset($_POST["drpusergroup"]) && $_POST["drpusergroup"]!="")			{$iUSER_GROUP		=	$_POST["drpusergroup"];		$sCriteriaSQL	.=	" AND u.user_group = ".$iUSER_GROUP;}
