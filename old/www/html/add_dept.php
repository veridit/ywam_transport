<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="adddept"){
			...
			$sSQL			=	"SELECT dept_name FROM tbl_departments WHERE dept_id = '".mysql_real_escape_string($_POST["txtdeptno"])."'";
			...
			if(mysql_num_rows($rsDUPLICATE)>0){
				...
				$sSQL			=	"SELECT dept_id FROM tbl_departments WHERE dept_name = '".mysql_real_escape_string($_POST["txtdeptname"])."'";							
			...
			if($bERROR	==	false){
				...
				"VALUES('".trim(mysql_real_escape_string($_POST["txtdeptno"]))."', '".trim(mysql_real_escape_string($_POST["txtdeptname"]))."', '".trim(mysql_real_escape_string($_POST["txtfname"]))."', '".trim(mysql_real_escape_string($_POST["txtlname"]))."', '".trim(mysql_real_escape_string($_POST["txtphone"]))."', ".
				"'".trim(mysql_real_escape_string($_POST["txtemail"]))."', '".mysql_real_escape_string(addslashes($_POST["txtInfo"]))."')";
				//print($sSQL);
