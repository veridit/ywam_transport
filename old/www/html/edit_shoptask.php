<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="editshop"){
			...
			$sSQL="UPDATE  tbl_shop_tasks SET miles_reading_tech='', last_mileage='".mysql_real_escape_string($_POST["txtlastmileage"])."', ".
			"work_type_id=".mysql_real_escape_string($_POST["drpworktype"]).", work_start_date='".$sWORKSTART_DATE."', next_oil = '".$sNEXTOIL_DATE."', total_cost=".mysql_real_escape_string($_POST["txtcost"]).", parts_source='".mysql_real_escape_string($_POST["txtparts"])."', ".
			"task_complete = ".$bCOMPLETED_TASK.", tech_comments='".mysql_real_escape_string(addslashes($_POST["txtcomments"]))."', ".
			"invoice_no = '', vendor_name = '".mysql_real_escape_string($_POST["txtvendor"])."' ".
