<?
	...
	$bCOMPLETED_TASK	=	0;		$bTEST_DRIVE_DONE	=	0;
		...
		$sWORKSTART_DATE		=	mysql_real_escape_string(substr($_POST["txtworkdate"],6, 4));
		$sWORKSTART_DATE		.=	mysql_real_escape_string("-".substr($_POST["txtworkdate"],0, 2));
		$sWORKSTART_DATE		.=	mysql_real_escape_string("-".substr($_POST["txtworkdate"],3, 2));
		
		$sNEXTOIL_DATE		=	mysql_real_escape_string(substr($_POST["txtnextoil"],6, 4));
		$sNEXTOIL_DATE		.=	mysql_real_escape_string("-".substr($_POST["txtnextoil"],0, 2));
		$sNEXTOIL_DATE		.=	mysql_real_escape_string("-".substr($_POST["txtnextoil"],3, 2));
			...
			"VALUES(".$_SESSION["User_ID"].", '".mysql_real_escape_string($_POST["drpvehicle"])."', '', '".mysql_real_escape_string($_POST["txtlastmileage"])."', ".mysql_real_escape_string($_POST["drpworktype"]).", ".
			"'".$sWORKSTART_DATE."', '".$sNEXTOIL_DATE."', ".mysql_real_escape_string($_POST["txtcost"]).", '".mysql_real_escape_string($_POST["txtparts"])."', ".
			"".$bTEST_DRIVE_DONE.", ".$bCOMPLETED_TASK.", '".addslashes($_POST["txtcomments"])."', '', '".mysql_real_escape_string($_POST["txtvendor"])."')";
			//print($sSQL);
