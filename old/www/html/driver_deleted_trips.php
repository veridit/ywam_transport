<?
	...
	if($iRECORD_COUNT<=0){$sMessage		=	fn_Print_MSG_BOX("no deleted trip found", "C_ERROR");}
									...
									<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
								 		<tr>			
								  			<td class="TextObject" align="center">
								   				<h1 style="margin-bottom: 0px;">DRIVER CANCELLED TRIPS</h1>
								  			</td>
								 		</tr>
									</table>
                   				</td>
				...
				<tr valign="top" align="left"><td colspan="4">&nbsp;</td></tr>
               	...
               	<tr valign="top" align="left">
                	...
                	<td width="949" class="TextObject" align="center">
						<form name="frm1" action="driver_deleted_trips.php" method="post">
									...
									<td>
										<table cellpadding="0" cellspacing="10" border="0" width="100%" align="center">
											<tr>
												...
												<td rowspan="2" align="center"><input type="button" name="btnGO" value=" GO " class="Button" style="width:50px;" onClick="fn_SEARCH();" /></td>
											</tr>
											<tr>
									...
									<td>
										<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
											...
											?>			<tr>
															...
															<td class="coldata" align="center"><a href="driver_cancelled_trip.php?resid=<? echo $rowRES['res_id'];?>">view</a></td>
