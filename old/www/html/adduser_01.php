<?php 
	...
	$arrPOST['txtcountry'] = "";
	$arrPOST['txtemail'] = "";
	$arrPOST['txtphone'] = "use hyphens";
	$arrPOST['drpmonth'] = "";
	$arrPOST['txtlicenseno'] = "";
	$arrPOST['txtlicensestate']= "";
	$arrPOST['txtmaxpassengers'] = "";
	$arrPOST['txtlicensecountry'] = "";
	$arrPOST['txtmaxpassengers'] = "";
	$arrPOST['txtlicenseexpire'] = "";
	$arrPOST['txtdrivetest'] = "";
	$arrPOST['txttestdate'] = "";
	$arrPOST['drpusertype'] = "";
	$arrPOST['drpdepartment'] = "";
	$arrPOST['chkterms'] = "";
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="adduser"){
			  ...
			  //checking errors
			  	...
			  	if(!isset($_POST['txtfname']) || $_POST['txtfname']==""){
					...
					$arrPOST['txtfname'] = $_POST['txtfname'];
			  	} else {
			  		$arrPOST['txtfname'] = $_POST['txtfname'];
			  	}
			  	...
			  	if(!isset($_POST['txtlname']) || $_POST['txtlname']==""){
			  		...
			  		$arrPOST['txtlname'] = $_POST['txtlname'];
			  	}else {
			  		$arrPOST['txtlname'] = $_POST['txtlname'];
			  	}
			  	...
			  	if(!isset($_POST['txtcountry']) || $_POST['txtcountry']==""){
					...
					$arrPOST['txtcountry'] = $_POST['txtcountry'];
				}else {
			  		$arrPOST['txtcountry'] = $_POST['txtcountry'];
			  	}
			  	...
			  	if (!isset($_POST['txtemail']) || $_POST['txtemail']==""){
					...
					$arrPOST['txtemail'] = $_POST['txtemail'];
				}else{
				...
				if ($_POST['txtphone']=="use hyphens"){
					...
					$arrPOST['txtphone'] = $_POST['txtphone'];
				}else {
			  		$arrPOST['txtphone'] = $_POST['txtphone'];
			  	}
				...
				if ($_POST['drpmonth'] == "" || $_POST['drpday'] == "" || $_POST['drpyear'] == ""){
					...
					$arrPOST['drpmonth'] = $_POST['drpmonth'];
				}
				...
				if (!isset($_POST['txtlicenseno']) || $_POST['txtlicenseno']==""){
					...
					$arrPOST['txtlicenseno'] = $_POST['txtlicenseno'];
				}else {
			  		$arrPOST['txtlicenseno'] = $_POST['txtlicenseno'];
			  	}
				...
				if (!isset($_POST['txtlicensestate']) || $_POST['txtlicensestate']==""){
					...
					$arrPOST['txtlicensestate'] = $_POST['txtlicensestate'];
				}else {
			  		$arrPOST['txtlicensestate'] = $_POST['txtlicensestate'];
			  	}
				...
				if (!isset($_POST['txtlicensecountry']) || $_POST['txtlicensecountry']==""){
					...
					$arrPOST['txtlicensecountry'] = $_POST['txtlicensecountry'];
				}else {
			  		$arrPOST['txtlicensecountry'] = $_POST['txtlicensecountry'];
			  	}
				...
				if (!isset($_POST['txtmaxpassengers']) || $_POST['txtmaxpassengers']==""){
					...
					$arrPOST['txtmaxpassengers'] = $_POST['txtmaxpassengers'];
				}elseif(intval($_POST['txtmaxpassengers']) < 5 || intval($_POST['txtmaxpassengers']) > 15){
					$arrERR[]			='<li>max allowed passengers must be in range 5-15';
					$arrPOST['txtmaxpassengers'] = $_POST['txtmaxpassengers'];
				}else {
			  		$arrPOST['txtmaxpassengers'] = $_POST['txtmaxpassengers'];
			  	}
				...
				if (!isset($_POST['txtlicenseexpire']) || $_POST['txtlicenseexpire']==""){
					$arrERR[]			='<li>please select license expire date';
			  		...
			  		$arrPOST['txtlicenseexpire'] = $_POST['txtlicenseexpire'];
			  	}
				...
				if(!isset($_POST['txtdrivetest']) || $_POST['txtdrivetest']==""){
			  		...
			  		$arrPOST['txtdrivetest'] = $_POST['txtdrivetest'];
			  	}else {
			  		$arrPOST['txtdrivetest'] = $_POST['txtdrivetest'];
			  	}
				if (!isset($_POST['txttestdate']) || $_POST['txttestdate']==""){
					$arrERR[]			='<li>please select Date tested here';
			  		...
			  		$arrPOST['txttestdate'] = $_POST['txttestdate'];
			  	}
				...
				if (!isset($_POST['drpdepartment']) || $_POST['drpdepartment']==""){
					$arrERR[]		='<li>please select your department';
			  		...
			  		$arrPOST['drpdepartment'] = $_POST['drpdepartment'];
			  	}
				if (!isset($_POST['chkterms'])){
					$arrERR[]		='<li>you must agree with the drivers agrement';
					$arrPOST['chkterms'] = $_POST['chkterms'];
				}else {
			  		$arrPOST['chkterms'] = $_POST['chkterms'];
			  	}
			  ...
			  if (!empty($arrERR)){
			  	...
			  	if($sMessage==""){
					...
					$sLicenseExpire =	fn_DATE_TO_MYSQL($_POST["txtlicetxtlnseexpire"]);

					if(isset($_POST["txtpermitdate"]) && $_POST["txtpermitdate"]!="") {
						$sEndPermit = fn_DATE_TO_MYSQL($_POST["txtpermitdate"]);
					} else {
						$iYear = date('Y');
						if (intval(date('m')) > 10) {
							$iYear += 1;
						}
						$sEndPermit =	$iYear . '-12-31';
					}
...
function valid_user(frm){
	...
	if (frm.txtmaxpassengers.value==""){
		...
		if (!validate_field(frm.txtmaxpassengers, regExp) || maxPasengers < 5 || maxPasengers > 15){
			sErrMessage=sErrMessage+'<li>max allowed passengers must be in range 5-15';
			iErrCounter++;
		}
	}
...
?>
	...
	if(frm.captcha.value==""){
		sErrMessage=sErrMessage+'<li>please enter image varification letters';
		iErrCounter++;
				...
				<tr valign="top" align="left"><td colspan="4">&nbsp;</td></tr>
               	...
               	<tr valign="top" align="left">
                	...
                	<td width="949" class="TextObject" align="center">
						<form name="frm1" action="adduser_01.php" method="post">
							<input type="hidden" name="action" value="adduser"	/>

							<table cellpadding="0" cellspacing="5" border="0" width="650" align="center" class="box">

								<tr><td colspan="2" id="Message" width="100%"><?php $sMessage?></td></tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" name="txtfname" value="<?php echo $arrPOST['txtfname'] ?>" maxlength="20" style="width:250px;"  /></td>
								</tr>
								<tr>
									<td class="label">Last Name:</td>
									<td><input type="text" name="txtlname" value="<?php echo $arrPOST['txtlname'] ?>" maxlength="20" style="width:250px;"  /></td>
								</tr>
								<tr>
									<td class="label">Home Country:</td>
									<td><input type="text" name="txtcountry" value="<?php echo $arrPOST['txtcountry'] ?>" maxlength="30" style="width:100px;"  /></td>
								</tr>
								<tr>
									<td class="label">Email:</td>
									<td><input type="text" name="txtemail" value="<?php echo $arrPOST['txtemail'] ?>" maxlength="150" style="width:250px;"  /></td>
								</tr>
								<tr>
									<td class="label">Phone:</td>
									<td><input type="text" name="txtphone" onclick="this.value='';" onblur="this.value=!this.value?'use hyphens':this.value;" value="<?php echo $arrPOST['txtphone'] ?>" maxlength="12" style="width:100px;" />&nbsp;xxx-xxx-xxxx</td>
								</tr>
								<tr>
									...
									<td>
										<?php 
											...
											for($iCounter=1;$iCounter<=12;$iCounter++){
												...
												echo "<option value='".$iMONTH."'>".date("F", mktime(0, 0, 0, $iCounter, 10))."</option>";
											}
											echo "</select>";
											echo "&nbsp;&nbsp;";
											...
											for($iCounter=1;$iCounter<=31;$iCounter++){
												if($iCounter<10) $iMONTH	=	"0".$iCounter; else $iMONTH	=	$iCounter;
												echo "<option value='".$iMONTH."'>".$iMONTH."</option>";
											}
											echo "</select>";
											echo "&nbsp;&nbsp;";
...
?>
								...
								<tr>
									...
									<td><input type="text" name="txtlicenseno" id="txtlicenseno" value="<?php echo $arrPOST['txtlicenseno'] ?>" maxlength="20" style="width:250px;" /></td>
								</tr>
								<tr>
									<td class="label">License State:</td>
									<td><input type="text" name="txtlicensestate" id="txtlicensestate" value="<?php echo $arrPOST['txtlicensestate'] ?>" maxlength="15" style="width:250px;" /></td>
								</tr>
								<tr>
									<td class="label">License Country:</td>
									<td><input type="text" name="txtlicensecountry" id="txtlicensecountry" value="<?php echo $arrPOST['txtlicensecountry'] ?>" maxlength="60" style="width:250px;" /></td>
								</tr>
								<tr>
									<td class="label">Govt. License Expires:</td>
									<td><input readonly="" type="text" name="txtlicenseexpire" id="txtlicenseexpire" value="<?php echo $arrPOST['txtlicenseexpire'] ?>" maxlength="10" style="width:100px;" class="date-pick dp-applied" /></td>
								</tr>
								<tr>
									<td class="label">Maximum Allowed Passengers:</td>
									<td><input type="text" name="txtmaxpassengers" id="txtmaxpassengers" value="<?php echo $arrPOST['txtmaxpassengers'] ?>" maxlength="2" style="width:250px;" /></td>
								</tr>
								<tr>
									<td class="label">Name of staff person who tested you:</td>
									<td><input type="text" name="txtdrivetest" id="txtdrivetest" value="<?php echo $arrPOST['txtdrivetest'] ?>" maxlength="30" style="width:250px;" /></td>
								</tr>
								<tr>
									<td class="label">Date tested here:</td>
									<td><input readonly="" type="text" name="txttestdate" id="txttestdate" value="<?php echo $arrPOST['txttestdate'] ?>" maxlength="10" style="width:100px;" class="date-pick dp-applied" /></td>
								</tr>
								<?php 
	if(isset($_SESSION["User_Group"]) && ($_SESSION["User_Group"]==$iGROUP_TM || $_SESSION["User_Group"]==$iGROUP_TC)){
...
?>
								<tr>
									<td class="label">This permit expires</td>
								...
								<tr>
									...
									<td><?php 
	fn_USER_GROUP('drpusergroup', '', "200", "1", "Select User Group");
...
?></td>
								...
								<tr>
									...
									<td>
									  ...
									  <img id="siimage" align="left" src="securimage/securimage_show.php?sid=<?php 
rand();

?>" style="border: 0pt none ; padding-right: 5px;"/>
