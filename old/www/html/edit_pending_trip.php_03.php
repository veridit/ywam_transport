						...
						<form name="frm1" action="edit_pending_trip.php" method="post">
							...
							<table cellpadding="0" cellspacing="5" border="0" width="650" align="center" class="box">
								...
								<tr>
									...
									<td><?	fn_DISPLAY_USERS('drpdriver', $rowRESERVATION['assigned_driver'], "150", "1", "Select Driver", "CONCAT(l_name, ' ', l_name) AS user_name", "l_name", $iGROUP_DRIVER.",".$iGROUP_COORDINATOR_STAFF);?></td>
								</tr>
								<tr>
