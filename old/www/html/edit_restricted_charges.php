<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="editrestricted"){
			...
			"AND dept_id = '".mysql_real_escape_string($_POST["drpdept"])."' AND charge_month = '".mysql_real_escape_string($_POST["drpmonth"])."' AND charge_year = '".mysql_real_escape_string($_POST["drpyear"])."'";
			...
			if($sMessage==""){
				...
				if($_POST["optmethod"]=="Total Charge"){
					...
					$sSQL="UPDATE tbl_restricted_charges SET vehicle_id = ".mysql_real_escape_string($_POST["drpvehicle"]).", dept_id = '".mysql_real_escape_string($_POST["drpdept"])."', ".
					"charge_month = '".mysql_real_escape_string($_POST["drpmonth"])."', charge_year = '".mysql_real_escape_string($_POST["drpyear"])."', ".
					"calc_method = 'Total Charge', total_charge = ".mysql_real_escape_string($_POST["txttotalcharge"]).", begin_mileage = NULL, end_mileage = NULL, rate = NULL WHERE charge_id = ".$iCHARGE_ID;
					
				}elseif($_POST["optmethod"]=="Readings"){
				
					$sSQL="UPDATE tbl_restricted_charges SET vehicle_id = ".mysql_real_escape_string($_POST["drpvehicle"]).", dept_id = '".mysql_real_escape_string($_POST["drpdept"])."', ".
					"charge_month = '".mysql_real_escape_string($_POST["drpmonth"])."', charge_year = '".mysql_real_escape_string($_POST["drpyear"])."', calc_method = 'Readings', ".
					"total_charge = ".mysql_real_escape_string($_POST["txtreadingcharges"]).", begin_mileage = '".mysql_real_escape_string($_POST["txtstartreading"])."', end_mileage = '".mysql_real_escape_string($_POST["txtendreading"])."', rate = ".mysql_real_escape_string($_POST["txtrate"])."  ".
