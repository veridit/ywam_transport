<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="addvehicle"){
		...
		$sREGISTER_DATE		=	fn_DATE_TO_MYSQL($_POST["txtregisterdate"]);
				...
				$sSQL	=	"SELECT vehicle_id FROM tbl_vehicles WHERE vehicle_no = '".mysql_real_escape_string($_POST["txtvno"])."'";
				...
				if (mysql_num_rows($rsVEHICLE_CHECK)>0){
					...
					"VALUES(".$_SESSION["User_ID"].", '".mysql_real_escape_string($_POST["txtvno"])."', '".mysql_real_escape_string($_POST["txtvinno"])."', '".mysql_real_escape_string($_POST["txtoilfilter"])."', '".$sINSPECT_DATE."', '".$sREGISTER_DATE."', '".mysql_real_escape_string($_POST["txtplateno"])."', ".mysql_real_escape_string($_POST["drpbrand"]).", ".mysql_real_escape_string($_POST["drpmodel"]).", ".
					"'".mysql_real_escape_string($_POST["txtyear"])."', '".mysql_real_escape_string($_POST["txtmileageun"])."', '".$sDATE_UN."', ".mysql_real_escape_string($_POST["txtcostun"]).", ".mysql_real_escape_string($_POST["txtcostrate"]).", ".
					"'".mysql_real_escape_string($_POST["txtcap"])."', '".mysql_real_escape_string($_POST["drpcondition"])."', '".mysql_real_escape_string(addslashes($_POST["txtrestriction"]))."', ".$bActive.", ".$bRestricted.", '".mysql_real_escape_string(addslashes($_POST["txtissuebyadmin"]))."')";
					//print($sSQL);
