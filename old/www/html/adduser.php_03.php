	...
	if(isset($_POST["action"])	&& $_POST["action"]=="adduser"){
			  ...
			  //checking errors
			  	...
			  	if (!isset($_POST['txtemail']) || $_POST['txtemail']==""){
					...
					$sSQL			=	"SELECT user_id FROM tbl_user WHERE email = '".$_POST["txtemail"]."'";
				...
				if ($_POST['drpmonth'] == "" || $_POST['drpday'] == "" || $_POST['drpyear'] == ""){
					...
					$sSQL	=	"SELECT user_id FROM tbl_user WHERE LOWER(l_name) = '".strtolower($_POST["txtlname"])."' AND birth_date = '".$sBirthDate."'";
				...
				if (!isset($_POST["captcha"]) || $_POST["captcha"]==""){
			  	...
			  	if($sMessage==""){
					...
					$sEndPermit			=	$_POST["txtpermitdate"]."-12-31";
					
					
					if(isset($_POST["drpusergroup"]) && $_POST["drpusergroup"]!=""){$sGROUP_SQL_VAL	=	$_POST["drpusergroup"];	}	//if tm or admin
					
					if($bCODE_WORD	==	true && $bLEADER_CODE	==	true)		$sGROUP_SQL_VAL	=	$iGROUP_DEPT_LEADER;		//leader is trying to register
			
					$sSQL="INSERT INTO  tbl_user(f_name, l_name, dept_id, phone, birth_date, license_no, license_state, license_expire, email, ".
					"password, drive_tested, test_date, end_permit, home_st_country, user_group, user_type ".
					$sPhotoSQL.", comment, renew_text, new_user) ".
					"VALUES('".$_POST["txtfname"]."', '".$_POST["txtlname"]."', '". $_POST["drpdepartment"] ."', '".$_POST["txtphone"]."', '".$sBirthDate."', '".$_POST["txtlicenseno"]."', '".$_POST["txtlicensestate"]."', '".$sLicenseExpire."', '".$_POST["txtemail"]."', ".
					"'".$sUSER_PWD."', '".addslashes($_POST["txtdrivetest"])."', '".$sTestDate."', '".$sEndPermit."', '".$_POST["txtcountry"]."', ".$sGROUP_SQL_VAL.", '".$_POST["drpusertype"]."', ".
					"'".$sUserPhoto."', '', '".addslashes($_POST["txtrenewtext"])."', 1)";
					//print($sSQL);
						...
						<form name="frm1" action="adduser.php" method="post">
							...
							<table cellpadding="0" cellspacing="5" border="0" width="650" align="center" class="box">
								...
								<tr>
									...
									<td><input type="text" name="txtfname" value="" maxlength="20" style="width:250px;"  /></td>
								</tr>
								<tr>
									<td class="label">Last Name:</td>
									<td><input type="text" name="txtlname" value="" maxlength="20" style="width:250px;"  /></td>
								</tr>
								<tr>
									<td class="label">Home Country:</td>
									<td><input type="text" name="txtcountry" value="" maxlength="30" style="width:100px;"  /></td>
								</tr>
								<tr>
									<td class="label">Email:</td>
									<td><input type="text" name="txtemail" value="" maxlength="150" style="width:250px;"  /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" name="txtlicenseno" id="txtlicenseno" value="" maxlength="20" style="width:250px;" /></td>
								</tr>
								<tr>
									<td class="label">License State:</td>
									<td><input type="text" name="txtlicensestate" id="txtlicensestate" value="" maxlength="15" style="width:250px;" /></td>
								</tr>
								<tr>
									<td class="label">Govt. License Expires:</td>
									<td><input readonly="" type="text" name="txtlicenseexpire" id="txtlicenseexpire" value="" maxlength="10" style="width:100px;" class="date-pick dp-applied" /></td>
								</tr>
								<tr>
									<td class="label">Name of staff person who tested you:</td>
									<td><input type="text" name="txtdrivetest" id="txtdrivetest" value="" maxlength="30" style="width:250px;" /></td>
								</tr>
								<tr>
									<td class="label">Date tested here:</td>
									<td><input readonly="" type="text" name="txttestdate" id="txttestdate" value="" maxlength="10" style="width:100px;" class="date-pick dp-applied" /></td>
								</tr>
								<tr>
									<td class="label">This permit expires December 31of</td>
									<td>
										<?	if(intval(date('m'))>=1	&&	intval(date('m'))<=10){?>
										<input readonly="" type="text" name="txtpermitdate" id="txtpermitdate" value="<? echo date('Y');?>" style="width:100px;"/>
										<?	}elseif(intval(date('m'))>=11	&&	intval(date('m'))<=12){?>
										<input readonly="" type="text" name="txtpermitdate" id="txtpermitdate" value="<? echo date('Y', strtotime(date("Y", strtotime(date('Y'))) . " +1 year"));?>" style="width:100px;"/>
										<?	}?>
									</td>
								</tr>
								...
								<tr>
									...
									<td><?	fn_USER_TYPE('drpusertype', '', "200", "1", "Select User Type");?></td>
								</tr>
								<tr>
									<td class="label">Home Dept:</td>
									<td><?	fn_DEPARTMENT('drpdepartment', '', "200", "1", "Select Department");?></td>
								</tr>
