<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="search"){
			...
			if(isset($_POST["drpvehicle"]) && $_POST["drpvehicle"]!="")	{$iVehicle_ID	=	$_POST["drpvehicle"];	$sCriteriaSQL	.=	" AND tbl_shop_tasks.vehicle_id = ".$iVehicle_ID;}
			if(isset($_POST["drpstatus"]) && $_POST["drpstatus"]!="")	{$sStatus		=	$_POST["drpstatus"];	$sCriteriaSQL	.=	" AND task_complete = ".$sStatus;}
