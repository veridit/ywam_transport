<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="search"){
		...
		if(isset($_POST["txtresvno"]) && $_POST["txtresvno"]!="")		{$iRES_SEARCH_ID=	$_POST["txtresvno"];	$sCriteriaSQL		.=	" AND tbl_reservations.res_id 			= 	".$iRES_SEARCH_ID;}
		if(isset($_POST["drpdrivername"]) && $_POST["drpdrivername"]!=""){$iDRIVER		=	$_POST["drpdrivername"];$sCriteriaSQL		.=	" AND tbl_reservations.assigned_driver 	=	".$iDRIVER;}
		if(isset($_POST["drprepeating"]) && $_POST["drprepeating"]!="")	{$bRepeating	=	$_POST["drprepeating"]; $sCriteriaSQL		.=	" AND tbl_reservations.repeating = ".$bRepeating;	}
		if(isset($_POST["drpdept"]) && $_POST["drpdept"]!="")			{$sDeptNo		=	$_POST["drpdept"];		$sCriteriaSQL		.=	" AND assigned.dept_id = '".$sDeptNo."'";			}
