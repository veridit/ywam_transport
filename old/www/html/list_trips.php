<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="search"){
			...
			if(isset($_POST["drpdept"]) && $_POST["drpdept"]!="")		{$sDeptNo		=	mysql_real_escape_string($_POST["drpdept"]);		$sCriteriaSQL	.=	" AND home_dept.dept_id = '".$sDeptNo."'";}
			if(isset($_POST["txtresvno"]) && $_POST["txtresvno"]!="")	{$iRES_ID		=	$_POST["txtresvno"];	$sCriteriaSQL	.=	" AND (tbl_trip_details.res_id = ".$iRES_ID." OR tbl_abandon_trips.res_id = ".$iRES_ID.")";}
			...
			if(isset($_POST["drpuser"]) && $_POST["drpuser"]!="")		{$iUSER_ID		=	mysql_real_escape_string($_POST["drpuser"]);		$sCriteriaSQL	.=	" AND tbl_reservations.user_id = ".$iUSER_ID;}
			if(isset($_POST["drptriplen"]) && $_POST["drptriplen"]!="")	{$iTRIP_LENGTH	=	mysql_real_escape_string($_POST["drptriplen"]);	$sCriteriaSQL	.=	" AND (tbl_trip_details.end_mileage - tbl_trip_details.begin_mileage) ".$iTRIP_LENGTH;}
			...
			if(isset($_POST["action"])	&& $_POST["action"]=="delete"){
				...
				$sMessage	=	fn_Print_MSG_BOX("trip has been deleted (pending status again)","C_SUCCESS");
			}
									...
									<table border="0" cellspacing="0" cellpadding="0" width="100%" height="100%">
								 		<tr>			
								  			<td class="TextObject" align="center">
								   				<h1 style="margin-bottom: 0px;">LIST CLOSED TRIPS</h1>
								  			</td>
								 		</tr>
									</table>
                   				</td>
				...
				<tr valign="top" align="left"><td colspan="4">&nbsp;</td></tr>
               	...
               	<tr valign="top" align="left">
                	...
                	<td width="949" class="TextObject" align="center">
						<form name="frm1" action="list_trips.php" method="post">
									...
									<td>
										<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
											<tr>
												...
												<td width="200" class="colhead">Destination</td>
												<td width="100" class="colhead">Closed By</td>
											...
											?>			<tr>
															...
															<td class="coldata"><? echo $rowTRIP['closing_user'];?></td>
															<td class="coldata" align="center"><a href="view_closed_trip.php?resid=<? echo $rowTRIP['res_id'];?>" title="VIEW">V</a></td>
														</tr>
											<?			}$listed++;	
													}
...
<?
function fn_TRIP_LAST_END_GAS($iRESERVATION_ID, $iVEHICLE_ID){
	$sSQL	=	"SELECT end_gas_percent FROM tbl_trip_details INNER JOIN tbl_reservations ON tbl_trip_details.res_id = tbl_reservations.res_id ".
	"WHERE tbl_reservations.res_id < ".$iRESERVATION_ID." AND tbl_reservations.vehicle_id = ".$iVEHICLE_ID." ORDER BY tbl_trip_details.res_id DESC LIMIT 1";
	
	/*SELECT tbl_trip_details.res_id, end_gas_percent FROM tbl_trip_details INNER JOIN tbl_reservations ON tbl_trip_details.res_id = tbl_reservations.res_id 
	WHERE tbl_reservations.res_id < 3756 AND tbl_reservations.vehicle_id = 16 ORDER BY tbl_trip_details.res_id DESC LIMIT 1*/
