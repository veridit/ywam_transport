                              ...
                              <div class="menu-container-1"> 
                                ...
                                <div class="column-1"> 
                                  ...
                                  <ul>
                                    ...
                                    <li><a href="adduser_01.php">User Registration <!--Step-2--></a></li>
                                    <?
                                        $res = mysql_query("select link_id, link_title from tbl_info_links where link_display_flag = 1 order by link_title") or die(mysql_error());
                                        while ($rowVals = mysql_fetch_array($res)) {
                                            echo '<li><a href="info_page.php?id='.$rowVals['link_id'].'">'.$rowVals['link_title'].'</a></li>'."\n";
                                        }
                                    ?>
                                    <? /*
