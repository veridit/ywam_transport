<?
	...
	//==============vehicle fields===============
	$sLIC_PLATE_NO		=	"";		$sVIN_NO		=	"";		$sOIL_FILTER	=	"";		$sSAFETY_DATE	=	"";
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="modifyvehicle"){
		...
		$sSQL="UPDATE tbl_vehicles SET user_id=".$_SESSION["User_ID"].", vin_no = '".$_POST["txtvinno"]."', oil_filter = '".$_POST["txtoilfilter"]."', ".
		"safety_date = '".$sINSPECT_DATE."', registration_date = '".$sREGISTER_DATE."', ".
		"lic_plate_no='".$_POST["txtplateno"]."', make_id=".$_POST["drpbrand"].", model=".$_POST["drpmodel"].", ".
		"year_manuf='".$_POST["txtyear"]."', mileage_un='".$_POST["txtmileageun"]."', date_to_un='".$sDATE_UN."', cost_to_un=".$_POST["txtcostun"].", cost_rate = ".$_POST["txtcostrate"].", ".
		"passenger_cap='".$_POST["txtcap"]."', condition_tech='".$_POST["drpcondition"]."', restriction='".addslashes($_POST["txtrestriction"])."', active = ".$bACTIVE.", restricted = ".$bRESTRICTED." ".
		", admin_issues = '".addslashes($_POST["txtissuebyadmin"])."' WHERE vehicle_id = ".$iVEHICLE_ID; 
		//print($sSQL);
