<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="editlink"){
		...
		if(isset($_POST["chkdisplay"]) && $_POST["chkdisplay"]!="")	$bHome_Page	=	1;
								
		$mainText = str_replace('<p align="center">', '<p align="center" style = "text-align:center;">', $_POST["txtinfo"]);
		$sSQL="UPDATE tbl_info_links SET link_title = '".mysql_real_escape_string(addslashes($_POST["txttitle"]))."', link_display_flag = ".$bHome_Page.", link_text = '".mysql_real_escape_string(addslashes($mainText))."' WHERE link_id = ".$iLINK_ID;
		//print($sSQL);
							...
							<table cellpadding="0" cellspacing="5" border="0" width="600" align="center" class="box">
								...
								<tr>
									<td>
										...
										<br /><br /><span class="label">&nbsp;&nbsp;Home Page</span>
										<input type="checkbox" name="chkdisplay" <? if ($rowLINK['link_display_flag'] == 1) { echo "checked"; }?> />
									</td>									
								</tr>								
								<tr><td>&nbsp;</td></tr>
								<tr>
