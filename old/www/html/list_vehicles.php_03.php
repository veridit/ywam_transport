<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="search"){
			...
			if(isset($_POST["drpcapacity"]) && $_POST["drpcapacity"]!="")		{$iCapacity		=	$_POST["drpcapacity"];		$sCriteriaSQL	.=	" AND v.passenger_cap IN (".$iCapacity.")";}
			if(isset($_POST["drptype"]) && $_POST["drptype"]!="")				{$iModelID		=	$_POST["drptype"];			$sCriteriaSQL	.=	" AND v.model= ".$iModelID;}
