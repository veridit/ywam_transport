...
<body style="background:none;">
						...
						if($sAction=="updatetrip"){
							...
							if(isset($_POST["txtvehicleno"])	&& $_POST["txtvehicleno"]!=""){	$iVEHICLE_ID	=	fn_GET_FIELD("tbl_vehicles", $_POST["txtvehicleno"], "vehicle_no", "vehicle_id");	}
							if($iVEHICLE_ID!="false"){
										...
										if($sMessage==""){
											...
											$sSQL="UPDATE tbl_reservations SET vehicle_id = ".$iVEHICLE_ID.", planned_passngr_no = '".$_POST["txtpassenger"]."', planned_depart_day_time = '".$sDEPART_DATETIME."', ".
											"planned_return_day_time = '".$sRETURN_DATETIME."', destination = '".addslashes($_POST["txtdestination"])."', ".
											"billing_dept = ".$_POST["drpdept"].", assigned_driver = ".$_POST["drpdriver"].", ".
											"key_no = '".$_POST['txtkey']."', card_no = '".$_POST['txtcard']."' ".
