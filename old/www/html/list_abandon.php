<?
	...
	if(isset($_POST["action"])	&& $_POST["action"]=="search"){
		...
		if(isset($_POST["txtresvno"]) && $_POST["txtresvno"]!="")	{$iRES_ID			=	mysql_real_escape_string($_POST["txtresvno"]);	$sCriteriaSQL	.=	" AND a.res_id = ".$iRES_ID;}
		...
		if(isset($_POST["drpdays"]) && $_POST["drpdays"]!="")		{$sDays				=	mysql__real_escape_string($_POST["drpdays"]);		$sINNER_CRITERIA=	" AND (TIMESTAMPDIFF(MONTH, CURDATE(), a.abandon_date) BETWEEN 0 AND ".$sDays.")";}
		...
		if(isset($_POST["drpdept"]) && $_POST["drpdept"]!="")		{$sDeptNo			=	mysql_real_escape_string($_POST["drpdept"]);		$sCriteriaSQL	.=	" AND reserv_user.dept_id = '".$sDeptNo."'";}
