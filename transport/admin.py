...
class AbandonTripsAdmin(admin.ModelAdmin):
...
class InfoLinksAdmin(admin.ModelAdmin):
...
class RestrictedChargesAdmin(admin.ModelAdmin):
...
class VehicleLimitAdmin(admin.ModelAdmin):
...
class ShopTasksAdmin(admin.ModelAdmin):
...
class ServiceReservationsAdmin(admin.ModelAdmin):
...
class ServiceReservationsDetailsAdmin(admin.ModelAdmin):
...
class DriverCommentsAdmin(admin.ModelAdmin):
...
class VehicleCommentsAdmin(admin.ModelAdmin):
