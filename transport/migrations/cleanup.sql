...
ALTER TABLE transport_info_links_position ADD COLUMN id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY;
DELETE FROM transport_info_links_position WHERE link_id NOT IN (SELECT id FROM transport_info_links);
ALTER TABLE transport_info_links_position ADD CONSTRAINT fk_transport_info_links FOREIGN KEY (link_id) REFERENCES transport_info_links(id);
