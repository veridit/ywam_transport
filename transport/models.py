...
class DriverLinksPosition(models.Model):
    ...
    class Meta:
        db_table = 'transport_driver_links_position'
...
class Reservations(models.Model):
    ...
    billing_department = models.ForeignKey('Departments', on_delete=models.DO_NOTHING, db_column='billing_department')
    assigned_driver = models.ForeignKey('Driver', on_delete=models.DO_NOTHING, db_column='assigned_driver', related_name='assigned_reservations')
    repeating = models.BooleanField()
    deleted_by_driver = models.ForeignKey('Driver', on_delete=models.DO_NOTHING, db_column='deleted_by_driver', blank=True, null=True, related_name='deleted_reservations')
...
class Vehicles(models.Model):
    ...
    make = models.ForeignKey('VehicleBrand', on_delete=models.DO_NOTHING)
    model = models.ForeignKey('VehicleType', on_delete=models.DO_NOTHING)
...
class ServiceReservationsDetails(models.Model):
    service_reservation = models.ForeignKey(ServiceReservations, on_delete=models.DO_NOTHING)
    reservation = models.ForeignKey(Reservations, on_delete=models.DO_NOTHING)
...
class DriverComments(models.Model):
    id = models.BigAutoField(primary_key=True)
    posting_user = models.ForeignKey(Driver, on_delete=models.DO_NOTHING, related_name='posted_comments')
    about_user = models.ForeignKey(Driver, on_delete=models.DO_NOTHING, related_name='received_comments')
    comments_date = models.DateTimeField()
    comments = models.TextField()
    trip = models.ForeignKey(TripDetails, on_delete=models.DO_NOTHING, blank=True, null=True)
...
class VehicleComments(models.Model):
    id = models.BigAutoField(primary_key=True)
    posting_user = models.ForeignKey(Driver, on_delete=models.DO_NOTHING)
    vehicle = models.ForeignKey(Vehicles, on_delete=models.DO_NOTHING)
